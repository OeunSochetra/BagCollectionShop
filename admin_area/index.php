...
<body>
        ...
        <div class="row">
            <div class="col-md-12 bg-info p-1 d-flex align-items-center ">
                ...
                <div class="button text-center">
                    ...
                    <button class="my-3"><a href="index.php?insert_products" class="nav-link text-light bg-info my-1">Insert Product</a></button>
    ...
    <div class="bg-info p-3 text-center">
            <p>All right reserved-Design by Group 1</p>
    </div>
