...
<table class="table table-bordered mt-5">
    ...
    <tbody class="bg-secondary text-light">
        ...
        <tr class="text-center">
            ...
            <td class="bg-success"><a href='index.php?edit_category=<?php echo $category_id ?>' class='text-dark'><i class='fa-solid fa-pen-to-square'></i></a></td>
            <td class="bg-danger"><a href='index.php?delete_category=<?php echo $category_id ?>' class='text-dark' type="button" data-toggle="modal" data-target="#exampleModal"><i class='fa-solid fa-trash'></i></a></td>
