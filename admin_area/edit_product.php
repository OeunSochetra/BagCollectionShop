    ...
    <?php
        if(isset($_POST['edit_product'])){
            ...
            if($product_title=='' or $product_desc=='' or $product_keyword=='' or $product_category=='' or $product_brand=='' or $product_image=='' or $product_price==''){
                ...
                $update_product="UPDATE `products` SET category_id='$product_category', product_title='$product_title', product_description='$product_desc', product_keywords='$product_keyword', product_price='$product_price', product_image='$product_image', date=NOW() WHERE product_id='$edit_id'";
