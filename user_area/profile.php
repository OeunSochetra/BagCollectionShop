        ...
        <div class="col-md-2 mt-5">
                <ul class="navbar-nav bg-secondary text-center">
                    ...
                    <li class="nav-item bg-warning">
                        <a href="profile.php" class="nav-link text-danger">Pending order</a>
                    </li>

                    <li class="nav-item bg-warning">
                        <a href="profile.php?edit_account" class="nav-link text-danger">Edit Account</a>
                    </li>

                    <li class="nav-item bg-warning">
                        <a href="profile.php?my_orders" class="nav-link text-danger">My orders</a>
                    </li>
                    ...
                    <li class="nav-item bg-warning">
                        <a href="user_logout.php" class="nav-link text-danger">Logout</a>
                    </li>
                </ul>
        </div>
